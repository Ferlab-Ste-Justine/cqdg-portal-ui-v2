...
const en = {
  entities: {
    ...
    participant: {
      ...
      submitter_participant_id: 'Submitter Participant ID',
  ...
  components: {
    search: {
      ...
      searchByParticipantIdTooltip: 'Search by Participant ID or Submitter Participant ID',
      ...
      searchBySampleIdTooltip: 'Search by Sample ID or Submitter Sample ID',
