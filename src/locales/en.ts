...
const en = {
  ...
  entities: {
    ...
    file: {
      ...
      'n=2': '(n={count})',
      nTooltip: 'Total number of files associated with the participant',
    },
    variant: {
      variant: 'Variant',
      variants: 'Variants',
  ...
  screen: {
    ...
    join: {
      ...
      submit: 'Submit',
      disclaimers: {
        title: 'CQDG Portal Registration Process',
        description:
          'The CQDG Portal is the primary entry point to the CQDG Data Hub. The CQDG Portal enables searching, visualizing, and accessing CQDG-relevant data. Some datasets may require additional approvals (e.g., dbGaP) and terms and conditions of access and use.',
        terms: {
          title: 'CQDG Portal Terms & Conditions',
          lastUpdate: 'Last Update: {date}',
          bullets: {
            1: 'My purpose for the use of CQDG Portal data is free from discrimination on the grounds of race, ethnicity, nationality, gender, age, physical and/or mental ability, sexual orientation, gender identity or expression, religion, or any other grounds that would impinge on an individual’s rights.',
            2: 'I will acknowledge specific dataset(s) and/or applicable accession number(s) as well as the CQDG Data Hub in my dissemination of research findings, as applicable to the medium or type of dissemination.',
            3: 'I will only share or distribute CQDG Portal data under terms consistent with this agreement, and the data or derivatives of the data may not be sold, in whole or in part, to any individual at any point in time for any purpose.',
            ...
            5: 'I agree to provide a brief statement regarding my intended use of the data on the CQDG Portal with my name and affiliation which will be publicly displayed for the purpose of transparency and collaboration.',
            6: 'I understand that participation in the CQDG community is voluntary and may be terminated by the CQDG Portal Administrator. I will report any actual or suspected violation of this agreement, even if unintentional, to the CQDG Portal Administrator. I understand that the CQDG Portal Administrator may take action to remedy any actual or suspected violation and/or report such behavior to the appropriate authorities.  I also understand that the CQDG Portal Administrator may immediately suspend or terminate my access to the CQDG Portal if there is an actual or suspected violation of this agreement.',
          },
          checkbox: 'I have read and agree to the CQDG Portal Terms and Conditions',
        },
        disclaimer: {
          title: 'CQDG Portal Disclaimers',
          bullets: {
            1: 'Data available in the CQDG Portal is provided on an AS-IS basis and may change over time.',
            2: 'The CQDG DCC does not warrant or assume any legal liability or responsibility for information, apparatus, product, or process contained in the CQDG Portal.',
            3: 'Content provided on the CQDG Portal is for informational purposes only and is not intended to be a substitute for independent professional medical judgment, advice, diagnosis, or treatment.',
          },
          checkbox: 'I have read and understand the CQDG Portal Disclaimers',
        },
        errors: 'Please accept the terms & conditions and portal disclaimers.',
      },
      registration: {
        notice:
          'Information provided here will be shared with the CQDG community on the CQDG Portal. All fields are required unless specified as optional.',
        sections: {
        ...
        labels: {
          ...
          intendToUser: 'I intend to use the CQDG Portal data for:',
