...
const fr = {
  ...
  screen: {
    ...
    dataExploration: {
      ...
      searchByBiospecimenId: 'Rechercher par biospecimen ID',
      searchByBiospecimenCollectionId: 'Rechercher par collection ID',
      ...
      savedBiospecimenSets: "Enregistrer l'ensemble de biospecimen",
