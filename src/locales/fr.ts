...
const fr = {
  entities: {
    ...
    biospecimen: {
      ...
      submitter_sample_id: `ID d'échantillon externe`,
      sample: 'Échantillon',
    ...
    participant: {
      ...
      submitter_participant_id: 'ID de participant externe',
  ...
  components: {
    search: {
      ...
      searchByParticipantIdTooltip: 'Recherche par ID de participant, ID de participant externe',
      ...
      searchBySampleIdTooltip: 'Recherche par ID d’échantillon, ID d’échantillon externe',
