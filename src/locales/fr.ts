...
const fr = {
  entities: {
    study: {
      ...
      data_collection_method: 'Méthodes de collecte de données',
      ...
      contact_name: 'Personne(s) contact',
      contact_institution: 'Institution(s) affiliée(s)',
      contact_email: 'Contact Email',
      website: 'Site web',
      funding_source: 'Source(s) de financement',
