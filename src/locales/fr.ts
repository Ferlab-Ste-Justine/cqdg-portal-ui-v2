  ...
  api: {
    ...
    report: {
      ...
      requestAccess: {
        ...
        okText: 'Télécharger',
        cancel: 'Annuler',
        text: `Télécharger les documents requis par les études pour votre demande d'accès aux données. Ces documents fournissent des informations sur les conditions d'utilisation des données autorisées ainsi qu'une liste complète par étude des fichiers sélectionnés. Pour en savoir davantage, `,
        textLink: `consulter la page Demande d'accès aux données`,
