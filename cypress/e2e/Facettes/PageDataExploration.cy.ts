...
describe('Page Data Exploration (Participants) - Filtrer avec les facettes', () => {
  ...
  it('Study Code - T-DEE', () => {
    ...
    cy.get('[class*="QueryValues_value"]').contains('T-DEE').should('exist');
  ...
  it('Diagnosis (ICD-10) - Generalized idiopathic epilepsy and epileptic syndromes, intractable (G40.31)', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Diagnosis (ICD-10)').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Generalized idiopathic epilepsy and epileptic syndromes, intractable (G40.31)').should('exist');
  ...
  it('Diagnosis (ICD-10) - Intellectual Disabilities (F70-F79)', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Diagnosis (ICD-10)').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Intellectual Disabilities (F70-F79)').should('exist');
  ...
  it('Gender - Female', () => {
    ...
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^1718$/).should('exist');
  });

  it('Gender - Male', () => {
    cy.checkValueFacetAndApply(2, /^Male$/);
    cy.get('[class*="QueryPill_field"]').contains('Gender').should('exist');
    cy.get('[class*="QueryValues_value"]').contains(/^Male$/).should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^1581$/).should('exist');
  });
  ...
  it('Ethnicity - French Canadian', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Ethnicity').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('French Canadian').should('exist');
  ...
  it.skip('Ethnicity - Mixed', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Ethnicity').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Mixed').should('exist');
  ...
  it('Phenotype (Source Text) - Intractable Seizures', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Phenotype (Source Text)').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Intractable Seizures').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^159$/).should('exist');
  });
  ...
  it('Phenotype (Source Text) - Microcephaly', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Phenotype (Source Text)').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Microcephaly').should('exist');
  ...
  it('Diagnosis (Source Text) - Intractable Epilepsy', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Diagnosis (Source Text)').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Intractable Epilepsy').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^159$/).should('exist');
  });
  ...
  it('Diagnosis (Source Text) - Mendelian disease', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Diagnosis (Source Text)').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Mendelian disease').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^639$/).should('exist');
  });
});
...
describe('Page Data Exploration (Biospecimens) - Filtrer avec les facettes', () => {
  ...
  it('Sample Type - DNA (NCIT:C449)', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Sample Type').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('DNA (NCIT:C449)').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^3299$/).should('exist');
  });
  ...
  it('Tissue - Blood (NCIT:C12434)', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Tissue').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Blood (NCIT:C12434)').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^3280$/).should('exist');
  });
  ...
  it.skip('Tissue - Saliva (NCIT:C13275)', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Tissue').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Saliva (NCIT:C13275)').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^19$/).should('exist');
  });
...
describe('Page Data Exploration (Data Files) - Filtrer avec les facettes', () => {
  ...
  it('Data Category - Genomics', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Data Category').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Genomics').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^20097$/).should('exist');
  });
  ...
  it('Data Type - Aligned Reads [CQDG-261]', () => {
    ...
    cy.get('[class*="QueryValues_value"]').contains('Aligned Reads').should('exist');
  ...
  it('Format - gVCF [CQDG-256]', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Format').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('gVCF').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^1119$/).should('exist');
  });
  ...
  it('Format - TBI', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Format').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('TBI').should('exist');
