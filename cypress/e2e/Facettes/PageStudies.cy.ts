...
describe('Page Studies - Filtrer avec les facettes', () => {
  ...
  it('Domain - General health', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Domain').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('General health').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^1 Results$/).should('exist');
  });
  ...
  it('Domain - Neurodevelopmental conditions', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Domain').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Neurodevelopmental conditions').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^1 Results$/).should('exist');
  });
  ...
  it('Population - Adult', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Population').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Adult').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^1 Results$/).should('exist');
  });
  ...
  it('Population - Pediatric and adult', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Population').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Pediatric and adult').should('exist');
  ...
  it('Access Limitation - General research use (DUO:0000042) [CQDG-281]', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Access Limitation').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('General research use (DUO:0000042)').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^1 Results$/).should('exist');
  });
  ...
  it('Access Limitation - No Data [CQDG-278]', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Access Limitation').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('No Data').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^3 Results$/).should('exist');
  });

  it('Access Requirement - Ethics approval required (DUO:0000021) [CQDG-281]', () => {
    cy.get('div[class*="Filters_customFilterContainer"]').eq(3).contains('Access Requirement').should('exist');
    cy.checkValueFacetAndApply(3, 'Ethics approval required (DUO:0000021)');
    cy.get('[class*="QueryPill_field"]').contains('Access Requirement').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Ethics approval required (DUO:0000021)').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^1 Results$/).should('exist');
  });

  it('Access Requirement - User specific restriction (DUO:0000026) [CQDG-281]', () => {
    cy.checkValueFacetAndApply(3, 'User specific restriction (DUO:0000026)');
    cy.get('[class*="QueryPill_field"]').contains('Access Requirement').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('User specific restriction (DUO:0000026)').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^1 Results$/).should('exist');
  });
});
