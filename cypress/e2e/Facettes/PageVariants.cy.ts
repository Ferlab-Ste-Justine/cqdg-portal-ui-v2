...
describe('Page Variants (Participant) - Filtrer avec les facettes', () => {
  ...
  it('Study Code - KF-NBL', () => {
    ...
    cy.get('[class*="QueryValues_value"]').contains('KF-NBL').should('exist');
  ...
  it('Study Code - KF-SCD', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Study Code').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('KF-SCD').should('exist');
  ...
  it.skip('Study Name - TODO', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Study Name').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('TODO').should('exist');
...
describe('Page Variants (Variant) - Filtrer avec les facettes', () => {
  ...
  it('Variant Type - Indel', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Variant Type').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Indel').should('exist');
  ...
  it('Consequence - Intron Variant', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Consequence').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Intron Variant').should('exist');
  ...
  it('Consequence - Missense Variant', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Consequence').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Missense Variant').should('exist');
  ...
  it('External Reference - DBSNP', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('External Reference').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('DBSNP').should('exist');
  ...
  it('External Reference - Clinvar', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('External Reference').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Clinvar').should('exist');
  ...
  it('Chromosome - 10', () => {
    ...
    cy.checkValueFacetAndApply(3, '10');
    cy.get('[class*="QueryPill_field"]').contains('Chromosome').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('10').should('exist');
  ...
  it('Chromosome - 20', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Chromosome').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('20').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^500$/).should('exist');
  });
  ...
  it('Zygosity - HET', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Zygosity').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('HET').should('exist');
  ...
  it('Zygosity - HOM', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Zygosity').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('HOM').should('exist');
  ...
  it('Transmission - Autosomal Dominant De Novo', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Transmission').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Autosomal Dominant De Novo').should('exist');
  ...
  it('Transmission - X Linked Dominant De Novo', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Transmission').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('X Linked Dominant De Novo').should('exist');
...
describe('Page Variants (Gene) - Filtrer avec les facettes', () => {
  ...
  it('Gene Type - Protein Coding', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Gene Type').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Protein Coding').should('exist');
  ...
  it('Gene Type - Processed Pseudogene', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('Gene Type').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Processed Pseudogene').should('exist');
  ...
  it('External Reference - OMIM', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('External Reference').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('OMIM').should('exist');
  ...
  it('External Reference - Orphanet', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('External Reference').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Orphanet').should('exist');
  ...
  it('HPO - Autosomal recessive inheritance (HP:0000007)', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('HPO').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Autosomal recessive inheritance (HP:0000007)').should('exist');
  ...
  it.skip('HPO - Short stature (HP:0004322)', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('HPO').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Short stature (HP:0004322)').should('exist');
  ...
  it('ORPHANET - West syndrome', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('ORPHANET').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('West syndrome').should('exist');
  ...
  it.skip('ORPHANET - Ochoa syndrome', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('ORPHANET').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Ochoa syndrome').should('exist');
  ...
  it('OMIM - 5-fluorouracil toxicity', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('OMIM').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('5-fluorouracil toxicity').should('exist');
  ...
  it.skip('OMIM - Cohen syndrome', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('OMIM').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Cohen syndrome').should('exist');
  ...
  it('DDD - UROFACIAL SYNDROME', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('DDD').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('UROFACIAL SYNDROME').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^24$/).should('exist');
  });
  ...
  it('COSMIC - Leukaemia', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('COSMIC').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Leukaemia').should('exist');
  ...
  it('COSMIC - Meningioma', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('COSMIC').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Meningioma').should('exist');
...
describe('Page Variants (Pathogenicity) - Filtrer avec les facettes', () => {
  ...
  it('ClinVar - Likely Benign', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('ClinVar').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Likely Benign').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^4$/).should('exist');
  });
  ...
  it('ClinVar - Uncertain Significance', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('ClinVar').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Uncertain Significance').should('exist');
  ...
  it('VEP - MODIFIER', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('VEP').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('MODIFIER').should('exist');
  ...
  it('VEP - HIGH', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('VEP').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('HIGH').should('exist');
    cy.get('div[class*="Header_ProTableHeader"]').contains(/^4$/).should('exist');
  });
  ...
  it('LRT - Neutral [CQDG-238,CQDG-258]', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('LRT').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Neutral').should('exist');
  ...
  it('LRT - Deleterious [CQDG-238,CQDG-258]', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('LRT').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Deleterious').should('exist');
  ...
  it('PolyPhen-2 HVAR - Benign [CQDG-238,CQDG-258]', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('PolyPhen-2 HVAR').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Benign').should('exist');
  ...
  it('PolyPhen-2 HVAR - Possibily Damaging [CQDG-238,CQDG-258]', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('PolyPhen-2 HVAR').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Possibily Damaging').should('exist');
  ...
  it('FATHMM - Tolerated [CQDG-238,CQDG-258]', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('FATHMM').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Tolerated').should('exist');
  ...
  it('SIFT - Tolerated [CQDG-258]', () => {
    ...
    cy.get('[class*="QueryPill_field"]').contains('SIFT').should('exist');
    cy.get('[class*="QueryValues_value"]').contains('Tolerated').should('exist');
