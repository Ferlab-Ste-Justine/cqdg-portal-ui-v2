...
describe('Page Variants - Bouton Save set', () => {
  ...
  beforeEach(() => {
    ...
    cy.get('[class*="SavedSets_setTabs"] [data-node-key="variants"]').click({force: true}); // data-cy="Tab_Biospecimens"
  ...
  it('Vérifier les informations affichées - Titre de la dropdown', () => {
    ...
    cy.get('[id="Variant-set-dropdown-container"] button').click({force: true});
  ...
  it('Valider les fonctionnalités du bouton - Save as new set [CQDG-772]', () => {
    ...
    cy.get('[class*="SavedSets_setTabs"] [class*="ant-tabs-tabpane-active"]').contains('Cypress_New_V').parentsUntil('[class*="ListItem_savedSetListItem"]').parent().find('[class*="ListItem_count"]').contains(/^1$/).click({force: true});
  });
  ...
  it('Valider les fonctionnalités du bouton - Add to existing set', () => {
    ...
    cy.get('[class*="ant-select-dropdown"]').contains('Cypress_V').click({force: true});
    ...
    cy.visitDashboard();
    cy.get('[class*="SavedSets_setTabs"] [data-node-key="variants"]').click({force: true});
    cy.get('[class*="SavedSets_setTabs"] [class*="ant-tabs-tabpane-active"]').contains('Cypress_V').parentsUntil('[class*="ListItem_savedSetListItem"]').parent().find('[class*="ListItem_count"]').contains(/^2$/).click({force: true});
    });
  ...
  it('Valider les fonctionnalités du bouton - Remove from existing set', () => {
    ...
    cy.visitDashboard();
    cy.get('[class*="SavedSets_setTabs"] [data-node-key="variants"]').click({force: true});
    cy.get('[class*="SavedSets_setTabs"] [class*="ant-tabs-tabpane-active"]').contains('Cypress_V').parentsUntil('[class*="ListItem_savedSetListItem"]').parent().find('[class*="ListItem_count"]').contains(/^0$/).click({force: true});
  });
});