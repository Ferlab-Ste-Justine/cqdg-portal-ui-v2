...
describe('Page d\'un fichier - Valider les redirections', () => {
  it('Studies', () => {
    cy.get('[data-cy="SummaryHeader_Studies_Button"]').find('[href]').clickAndWait({force: true});
  ...
  it('Sample', () => {
    cy.get('[data-cy="SummaryHeader_Samples_Button"]').find('[href]').clickAndWait({force: true});
...
describe('Page d\'un fichier - Valider les liens disponibles', () => {
  ...
  it('Lien Participant du panneau Participants-Samples', () => {
    cy.get('[id="biospecimens"]').find('td[class="ant-table-cell"]').eq(0).find('[href]').clickAndWait({force: true});
  ...
  it('Lien Study du panneau Participants-Samples', () => {
    cy.get('[id="biospecimens"]').find('td[class="ant-table-cell"]').eq(1).find('[href]').clickAndWait({force: true});
  ...
  it('Lien File du panneau Files Generated by the Analysis', () => {
    cy.get('[id="analysis_files"]').find('[data-cy="Link_File_FI0001222"]').clickAndWait({force: true});
...
describe('Page d\'un fichier - Valider les panneaux masquables', () => {
  ...
  it('Panneau Data Type', () => {
    ...
    cy.get('[id="data_type"]').find('span[class*="ant-collapse-arrow"]').clickAndWait({force: true});
  ...
  it('Panneau Participants-Samples', () => {
    ...
    cy.get('[id="biospecimens"]').find('span[class*="ant-collapse-arrow"]').clickAndWait({force: true});
  ...
  it('Panneau Experimental Procedure', () => {
    ...
    cy.get('[id="experimental_procedure"]').find('span[class*="ant-collapse-arrow"]').clickAndWait({force: true});
  ...
  it('Panneau Analysis Properties', () => {
    ...
    cy.get('[id="analysis"]').find('span[class*="ant-collapse-arrow"]').clickAndWait({force: true});
  ...
  it('Panneau Files Generated by the Analysis', () => {
    ...
    cy.get('[id="analysis_files"]').find('span[class*="ant-collapse-arrow"]').clickAndWait({force: true});
