...
describe('Page d\'un variant - Vérifier les informations affichées', () => {
  ...
  it('Panneau Summary', () => {
    ...
    cy.get('div[class*="EntityVariantSummary_bannerWrapper"] [class="ant-space-item"]').eq(11).contains('1 / 6(1.67e-1)').should('exist');
    ...
    cy.get('div[class*="EntityVariantSummary_infoWrapper"] div[class*="ant-space-horizontal"]').eq(2).contains('NM_022367.4').should('exist');
    ...
    cy.get('div[class*="EntityVariantSummary_omim"] [class="ant-descriptions-item-content"]').eq(0).find('[class*="ant-tag-blue"]').contains('AD').should('exist');
    cy.get('div[class*="EntityVariantSummary_omim"] [class="ant-descriptions-item-content"]').eq(0).find('[class*="ant-tag-blue"]').contains('AR').should('exist');
  });
  ...
  it('Panneau Transcripts', () => {
    ...
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class="ant-table-cell"]').eq(6).contains('NM_022367.4').should('exist');
  ...
  it('Panneau CQDG Studies', () => {
    ...
    cy.get('[id="frequency"] thead th[class="ant-table-cell"]').eq(1).contains('Domain').should('exist');
    cy.get('[id="frequency"] thead th[class="ant-table-cell"]').eq(2).contains('Participants').should('exist');
    cy.get('[id="frequency"] thead th[class="ant-table-cell"]').eq(3).contains('Frequency').should('exist');
    cy.get('[id="frequency"] thead th[class="ant-table-cell"]').eq(4).contains('# ALT Alleles').should('exist');
    cy.get('[id="frequency"] thead th[class="ant-table-cell"]').eq(5).contains('# Homozygotes').should('exist');
    cy.get('[id="frequency"] [class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(0).contains('STUDY1').should('exist');
    cy.get('[id="frequency"] [class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(1).contains('Rare Diseases').should('exist');
    cy.get('[id="frequency"] [class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(2).contains('1 / 6').should('exist');
    cy.get('[id="frequency"] [class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(3).contains('8.33e-2').should('exist');
    cy.get('[id="frequency"] [class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(4).contains('1').should('exist');
    cy.get('[id="frequency"] [class*="ant-table-row"]').eq(0).find('td[class="ant-table-cell"]').eq(5).contains('0').should('exist');
    cy.get('[id="frequency"] tfoot[class="ant-table-summary"] td[class*="ant-table-cell"]').eq(1).contains(/$^/).should('exist');
    cy.get('[id="frequency"] tfoot[class="ant-table-summary"] td[class*="ant-table-cell"]').eq(2).contains('1 / 6').should('exist');
    cy.get('[id="frequency"] tfoot[class="ant-table-summary"] td[class*="ant-table-cell"]').eq(3).contains('1.67e-1').should('exist');
    cy.get('[id="frequency"] tfoot[class="ant-table-summary"] td[class*="ant-table-cell"]').eq(4).contains('1').should('exist');
    cy.get('[id="frequency"] tfoot[class="ant-table-summary"] td[class*="ant-table-cell"]').eq(5).contains('0').should('exist');
  });
  ...
  it('Panneau Public Cohorts', () => {
    ...
    cy.get('[data-row-key="topmed"] td[class="ant-table-cell"]').eq(2).contains('126K').should('exist');
    ...
    cy.get('[data-row-key="gnomadGenomes3"] td[class="ant-table-cell"]').eq(2).contains('152K').should('exist');
    ...
    cy.get('[data-row-key="gnomadGenomes2_1"] td[class="ant-table-cell"]').eq(2).contains('31.4K').should('exist');
    ...
    cy.get('[data-row-key="gnomadExomes2_1"] td[class="ant-table-cell"]').eq(2).contains('251K').should('exist');
...
describe('Page d\'un variant - Valider les liens disponibles', () => {
  ...
  it('Lien du RefSeq du panneau Transcripts', () => {
    cy.get('[id="consequence"] tbody td[class*="ant-table-row-expand-icon-cell"]').eq(0).find('button').clickAndWait({force: true});
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class*="ant-table-cell"]').eq(6).find('a').should('have.attr', 'href', 'https://www.ncbi.nlm.nih.gov/nuccore/NM_022367.4?report=graph');
  });
  ...
  it('Lien \'See more\' de RefSeq du panneau Transcripts', () => {
    ...
    cy.get('[id="consequence"] div[class*="VariantEntity_expandedTable"] tbody td[class*="ant-table-cell"]').eq(6).find('[class*="ant-space-item"]').eq(1).contains('NM_001193300.2').should('exist');
